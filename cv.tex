...
\item Decentralized apps op de Ethereum blockchain
  	...
  	\begin{itemize}
  		\item Gentse Feesten \\ 
  			Chatbot voor evenementen / info Gentse Feesten gebruik makende van de Linked Open Data Gentse Feesten \\ 
  			(\url{https://github.com/lab9k/chatbot-visit-gent})
  		\item Citynet Gent \\ 
  			Chatbot bedoeld vragen te beantwoorden in verband met de besluitsvormingen van het Gentse stadsbestuur 
  			gebruik makende van de CityNet API \\ 
  			(\url{https://github.com/lab9k/chatbot-nalantis})
  		\item Toerisme Gent \\ 
  			Chatbot voor toerisme in Gent gebruik makende van de Linked Open Data Visit Gent \\ 
  			(\url{https://github.com/lab9k/chatbot-toerisme-gent})
  	\end{itemize}
\end{itemize}}
\cventry{zomer 2019}{Vakantiejob bij TomTom}{}{}{}{Ontwikkelen van interne tools in maps transformations team}
